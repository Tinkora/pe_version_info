...
def main() -> None:
    ...
    for marker in (
        ...
        "x86_64-unknown-linux-gnu=artifacts.cargo-metadata-x86_64-unknown-linux-gnu.json",
        "aarch64-apple-darwin=artifacts.cargo-metadata-aarch64-apple-darwin.json",
        "x86_64-pc-windows-msvc=artifacts.cargo-metadata-x86_64-pc-windows-msvc.json",
        "actions/attest@",
        "subject-checksums",
        "sbom-path",
    ):
